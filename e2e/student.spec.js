...
test('test', async ({ page }) => {
  ...
  await page1.getByRole('textbox', { name: 'Enter Student Name' }).click();
  await page1.getByRole('textbox', { name: 'Enter Student Name' }).fill('Student one');
  ...
  await page1.getByRole('textbox', { name: 'Enter Aadhaar Number' }).fill('622361530197');
  ...
  await page1.getByRole('textbox', { name: 'Enter Name as per Aadhaar' }).fill('student one');
  await page1.locator('.form-select.ng-untouched.ng-pristine.ng-invalid').first().selectOption('1');
  ...
  await page1.getByRole('button', { name: 'Browse' }).first().click();
  await page1.getByRole('button', { name: 'Browse' }).first().setInputFiles('Sample document.pdf');
  await page1.getByRole('button', { name: 'Browse' }).nth(3).click();
  await page1.getByRole('button', { name: 'Browse' }).nth(3).setInputFiles('Sample document.pdf');
  await page1.getByRole('button', { name: ' Save & Next' }).click();
  await expect(page1.getByRole('dialog', { name: 'Are you sure?' })).toBeVisible();
