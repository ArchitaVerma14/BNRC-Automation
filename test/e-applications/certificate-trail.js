...
describe('Certificate Verification Automation', function () {
    ...
    it('should register a certificate verification with sample data', async function () {
        ...
        await driver.sleep(3000); // let page load

        await driver.takeScreenshot().then((img) => {
        writeFileSync('debug.png', img, 'base64');
        });
        ...
        await driver.wait(until.elementIsVisible(eAppDropdown), 20000);
    ...
    const dobInput = await driver.findElement(By.css("input[formcontrolname='dob']"));
      ...
      //  await year2003.click();
        ...
        const organizationLetterPath = resolve("./Sample document.pdf");
        // Attach the file
        await fileInput.sendKeys(organizationLetterPath);
        ...
        // Provide the full path to your PDF file
        const certificatePath = resolve("./Sample document.pdf");
