...
describe('Transfer Registration Automation', function () {
 ...
 10000);
        ...
        const certOption = await driver.wait(until.elementLocated(By.css('a.dropdown-item[href="/bnrc_stg/Website/transferIntoBihar"]')), 10000);
        await safeClick(driver, certOption);
        ...
        await selectDropdown(driver, "select[formcontrolname='districtId']", 'GAYA JI');
        ...
        await councilDropdown.sendKeys("Goa");
        ...
        const day30 = await driver.findElement(By.xpath("//span[text()='30']"));
        await safeClick(driver, day30);

        // File uploads
        const filePaths = Array(8).fill("C:\\Users\\Harsh\\Downloads\\Sample document.pdf");
 ...
 3000);
    ...
    try {
        ...
        // Final OK
        const okBtn = await driver.wait(until.elementLocated(By.xpath("//button[contains(text(),'OK')]")),10000);
