...
$File = "C:\Users\Harsh\Downloads\new-course\bnrc-tests\tests\e-applications\transfer_copy.js"
...
$Screenshot = "C:\Users\Harsh\Downloads\new-course\bnrc-tests\BNRCscreenshots\transfer_registration_success.png"

$CleanFile = $File -replace '[^\x00-\x7F]', ''
# Determine status
if ($ExitCode -eq 0) {
    $Subject = "PASS Mocha Test Success: Transfer Certification"
    $Body = "Script executed successfully.`n`nLogs:`n$CleanOutput"
} else {
    $Subject = "FAIL Mocha Test Failed: Transfer Certification"
