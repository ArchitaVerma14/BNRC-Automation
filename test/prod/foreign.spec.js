    ...
    it('should register a foreign verification with sample data', async function () {
      ...
      //  const okButton = await driver.wait(
        ...
        const certOption = await driver.wait(
            until.elementLocated(By.xpath('//a[contains(text(), "Foreign Verification")]')),
            10000
        );
      ...
      //  await fillField("input[formcontrolname='registrationNumber']", 'REG' + Math.floor(Math.random() * 100000));
        ...
        const intermediateOption = await driver.findElement(By.xpath("//option[text()='Matriculation']"));
        ...
        const path = require('path');
            ...
            const certificatePath = path.resolve("C:\\Users\\Harsh\\Downloads\\Sample document.pdf");
